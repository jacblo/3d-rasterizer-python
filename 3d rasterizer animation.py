...
def renderImg(path):
    ...
    for x in mesh["tris"]:
        ...
        fillTri(a[0], a[1], b[0], b[1], c[0], c[1],shade((240,240,240),x[1]))
...
for w in range(100):
    ...
    mesh = {}
    with open(f"/home/y3/Documents/Python Scripts/animation/meshForRenderer{w}.json",mode = "r")as f:
        mesh = json.loads(f.read())
    renderImg("/home/y3/Documents/Python Scripts/animation/render/"+str(w)+".png")